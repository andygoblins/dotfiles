...
bindkey -M goblin "^[OH" beginning-of-line
...
bindkey -M goblin "^[OD" backward-char
...
bindkey -M goblin "^[OC" forward-char
...
bindkey -M goblin "^[OB" down-line-or-history
...
bindkey -M goblin "^[OA" up-line-or-history
bindkey -M goblin "^[." beginning-of-history
